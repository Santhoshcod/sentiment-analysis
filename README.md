...
1. Clone the repository:git clone https://github.com/Santhoshcod/sentiment-analysis.git

2. Download the data zip file from [here]https://github.com/Santhoshcod/sentiment-analysis/blob/main/text%20csv%20file.zip
